...
fun <T> getPlaceHolder(
    ...
    if (imageLoadersArray[0] == imageLoaderType) {
        drawableTypeRequest.error(R.drawable.ic_launcher_background)
        drawableTypeRequest.placeholder(R.drawable.ic_launcher_background)
        ...
        drawableTypeRequest.error(R.color.black)
        drawableTypeRequest.placeholder(R.color.texts)
    }
